  ...
  sidebarLayout(
    sidebarPanel(
      ...
      tags$div(
        ...
        br(),
        "Calculates the max production percentage for tilt and azimuth for fixed solar panels",
        br(),
        br(),
        ...
        br(),
        "Code available: https://github.com/rccline/shiny_solar_production.git",
        br(),
